...
public class Quaternion {
	...
	public Quaternion multiply(final Quaternion that) {
		 ...
		 */
		float s = this.s * that.s - this.v[0] * that.v[0] - this.v[1] * that.v[1] - this.v[2] *that.v[2];
		...
		Quaternion newQuaternion = new Quaternion(s, i, j, k);
	...
	private float norm() {
		 ...
		 * ************* Implement Your Code Here *************
		 */
		double norm = Math.sqrt(Math.pow(this.s, 2) + Math.pow(this.v[0], 2) + Math.pow(this.v[1], 2)+ Math.pow(this.v[2], 2));
